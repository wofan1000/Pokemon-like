...
public class QuestObject : MonoBehaviour
{
    ...
    {
        if(onStart != ObjectActions.Nothing && questList.IsStarted(questToCheck.Name))
        {
        ...
        if (onComplete != ObjectActions.Nothing && questList.IsCompleted(questToCheck.Name))
        {
            foreach (Transform child in transform)
            {
...
public enum ObjectActions { Nothing ,Enable, Disable}
